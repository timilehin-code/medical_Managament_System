        ...
        <div class="login-forms">
            <div class="container">
                ...
                <div class="d-flex sub mt-5">
                    <!-- <button class="btn btn-tabs">Admin</button> -->
                    <!-- <button class="btn btn-tabs">Doctor</button> -->
                    <!-- <button class="btn btn-tabs">Patient</button> -->
                </div>
                <div class="px-5 form-section">
                    ...
                    <div class="">
                        ...
                        <form action="" class=" mt-3" method="POST">
                            ...
                            <div class="form-group">
                                <input type="email" name="pEmail" id="pEmail" class="w-100 p-2 mt-1"
                                    placeholder="Email">
                                <label class="form-label">Email</label>
                                <p class="text-danger msg"></p>
                            </div>
                            <div class="form-group">
                                <input type="password" name="pPassword" id="password" class="w-100 p-2 mt-1"
                                    placeholder="Password">
                                <label class="form-label">Password</label>
                                <p class="text-danger msg2"></p>
                            </div>
                            ...
                            <button type="submit" name="pSubmit" class="btn login w-100 mt-3">Log In</button>
                        </form>
                    </div>
                </div>
            </div>
